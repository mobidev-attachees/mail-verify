...
<div style="padding-left: 30px; border-width: 2px;">
    ...
    <div class="container" style="border-style: solid; border-width: 1px;border-radius: 30px;margin:auto;width: 100%;padding-bottom: 50px;">
        <div class="row" style="margin-top: 20px; padding-right:70px;">
